    ...
    public void configure(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .antMatchers("/","/showFile/**","/v1/showFile/**","/v1/upload", "/user-register/**","/swagger-ui/**","/swagger-ui.html","/v3/api-docs/**","/user-login/**",
                        "/forget-password/**", "/oauth/authorize**", "/login**", "/error**", "/v1/user-register/**", "/v1/user-login/login", "/user-login/kafka/**")
                .permitAll()
                ...
                .antMatchers("/v1/merchant/**").hasAnyAuthority("ROLE_MERCHANT")
                .and()
                .authorizeRequests()
                .anyRequest()
                .authenticated()
